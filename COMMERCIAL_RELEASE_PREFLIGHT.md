...
1. Razorpay mode for the controlled launch test: test mode first, then live mode only after success.
2. Named authorization to sell this exact learner pack at ₹29.
3. Named authorization to activate the storefront listing.
4. Confirmation that the displayed business, contact, terms, privacy and refund details are complete and accurate for launch. The legal seller name, geographic address, customer-care phone and grievance contact are still missing.
